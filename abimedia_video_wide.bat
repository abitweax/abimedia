@ECHO OFF
REM video-to-webm-40-scale-840x472.sh
SET LOG=%TEMP%\abimedia_video_log.txt

ECHO abimedia_video_log.bat >%LOG%
...
"%1\ffmpeg\bin\ffmpeg.exe" -i %2 -c:v libvpx-vp9 -crf 40 -b:v 0 -vf scale=840:472 -g 50 -an "%TEMP_VIDEO%"
